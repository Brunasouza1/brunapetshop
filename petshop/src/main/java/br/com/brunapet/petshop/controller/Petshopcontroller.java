package br.com.brunapet.petshop.controller;
...
import br.com.brunapet.petshop.service.Petservice;
...
public class Petshopcontroller {
    ...
    @GetMapping
    public ResponseEntity<List <Pet>> obterTodosOsPet(){
        return new ResponseEntity<>(servico.obterTodosOsPet(),HttpStatus.OK);
    }
